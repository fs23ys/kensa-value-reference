(function () {
  ...
  function exportWorkbook() {
    var wb = { SheetNames: [], Sheets: {} };
    wb.SheetNames.push(LAB_SHEET_NAME);
    wb.Sheets[LAB_SHEET_NAME] = aoaToSheet(rowsToAOA(LAB_COLUMNS, state.labRawRows));
    wb.SheetNames.push(DISEASE_SHEET_NAME);
    wb.Sheets[DISEASE_SHEET_NAME] = aoaToSheet(rowsToAOA(DISEASE_COLUMNS, state.diseaseRawRows));
    var d = new Date();
